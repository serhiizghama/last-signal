...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      ...
      { name: MarketExchange.name, schema: MarketExchangeSchema },
      { name: Notification.name, schema: NotificationSchema },
      { name: ChangeStreamResumeToken.name, schema: ChangeStreamResumeTokenSchema },
    ]),
  ],
